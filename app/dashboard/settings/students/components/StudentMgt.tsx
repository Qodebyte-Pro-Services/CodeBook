        ...
        <div className="flex flex-col gap-5 w-full ">
          <div className="bg-white rounded-lg mt-2 shadow overflow-hidden">
            ...
            <div className="flex flex-col gap-1 px-2 py-2">
              ...
              <span className="text-gray-700 text-xs">Manage your school&apos;s students</span>
            </div>
          </div>
          ...
          <div className="bg-gray-100 rounded-t-md px-4 py-3 font-semibold text-gray-700">
              ...
              <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">30 hours a Week</p>
                </div>
              ...
              <div className='pt-3 flex px-5 flex-col gap-2'>
                ...
                <div className='grid md:grid-cols-2 grid-cols-1 gap-2'>
                <span  className='text-gray-500'>Extra Lessons</span>
                <p>15:00pm - 05:00pm</p>
                </div>

                <div className='grid md:md:grid-cols-2 grid-cols-1 gap-2'>
                <span  className='text-gray-500'>Daily School hours</span>
               <div className='grid  gap-2'>
