...
const FormStep4: React.FC<FormStep4Props> = ({ currentStep, onNext, formData, updateFormData, completedSteps, setCompletedSteps,onStepChange }) => {
  ...
  const fields = useMemo(() => [
    { name: 'verificationId', label: 'Upload Verification ID', type: 'file', required: true }, 
  ], []);
  ...
  return (
    ...
    <div className='flex w-full  justify-center py-[1.5rem]'>
          ...
          <div className='lg:flex hidden lg:w-1/2 bg-[#DAF2FF] w-0 h-full rounded-bl-[20px] shadow-bl-2xl  items-center justify-center overflow-hidden '>
            ...
            <Image src='/image-8.png' alt='login' fill />
            </div>
          </div>
            <div className='lg:w-1/2 h-full w-full flex flex-col text-center px-2 py-[1rem] justify-center'>
                <div className='flex flex-col  justify-center gap-4'>
                <h1 className="text-gray-950 font-medium  md:text-2xl text-xl">Upload Verification Id </h1>
      <h4 className="text-gray-950 font-medium md:text-lg text-md mb-4">Upload the verifcation document for proof of validation</h4>
      <FormStepsNavigation
